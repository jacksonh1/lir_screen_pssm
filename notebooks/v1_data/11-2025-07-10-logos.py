...
plt.tight_layout()
plt.savefig(output_dir / f"11-{plot_count}-lir_central-logos.png", dpi=300, bbox_inches="tight")
plot_count += 1
...
plt.tight_layout()
plt.savefig(output_dir / f"11-{plot_count}-screen_z-score_ranges.png", dpi=300, bbox_inches="tight")
plot_count += 1
...
fig.savefig(output_dir / f"11-{plot_count}-motif_counts.png", dpi=300, bbox_inches="tight")
plot_count += 1
...
fig.savefig(output_dir / f"11-{plot_count}-logo-aromatic.png", dpi=300, bbox_inches="tight")
plot_count += 1
fig, ax = plt.subplots(figsize=(7, 2.5))
...
ax.set_ylabel("count")
ax.set_xlabel("Position")
fig.savefig(output_dir / f"11-{plot_count}-logo-classic.png", dpi=300, bbox_inches="tight")
plot_count += 1
...
ax.set_ylabel("count")
ax.set_xlabel("Position")
fig.savefig(output_dir / f"11-{plot_count}-logo-all-screen.png", dpi=300, bbox_inches="tight")
plot_count += 1
...
ax.set_ylabel("count")
ax.set_xlabel("Position")
fig.savefig(output_dir / f"11-{plot_count}-logo-nonbinders.png", dpi=300, bbox_inches="tight")
plot_count += 1
...
ax.set_ylabel("count")
ax.set_xlabel("Position")
fig.savefig(output_dir / f"11-{plot_count}-logo-ilir.png", dpi=300, bbox_inches="tight")
plot_count += 1
