...
# %%
BGFREQS = dl.get_background_frequencies("v1")
BGFREQS
...
pssms.plot_logo_as_heatmap(
    make_pssm(ilir_binders, bg=BGFREQS.ilir_bg, min_count=0, plot_title='fg: ilir, bg: ilir'),
)

# %%
fg_ilir_bg_ilir = make_pssm(ilir_binders, bg=BGFREQS.ilir_bg, min_count=0, plot_title='fg: ilir, bg: ilir');
fg_ilir_bg_proteome = make_pssm(ilir_binders, bg=BGFREQS.proteome, min_count=0, plot_title='fg: ilir, bg: proteome');
...
fg_ilir_bg_proteome = make_pssm(ilir_binders, bg=BGFREQS.proteome, min_count=0, plot_title='fg: ilir, bg: proteome, pseudocount=1', pseudocount=1, ax=ax);
...
make_pssm(
    sb_all,
    bg=BGFREQS.nonbinders_undef_pos,
    min_count=5,
