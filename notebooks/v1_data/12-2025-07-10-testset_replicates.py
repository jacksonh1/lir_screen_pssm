...
# %% [markdown]
# # dataset v2 = no more than 1 regex match per sequence in the screening data

# %%
k = set(PROCESSED_SEQUENCE_TABLES.ilir_binders["7mer"].to_list())
x = set(PROCESSED_SEQUENCE_TABLES.screen_binders["7mer"].to_list())
y = set(PROCESSED_SEQUENCE_TABLES.screen_nonbinders["7mer"].to_list())
z = set(TEST_SETS.lir_central["7mer"].to_list())
...
def driver(
    ...
    foregrounds["screen: (cheating)"] = PROCESSED_SEQUENCE_TABLES.screen_binders.copy()["7mer"].to_list()
