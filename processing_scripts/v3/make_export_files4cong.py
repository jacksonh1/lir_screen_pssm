...
screen_binders[["7mer", "true label", "avg_z_score", "lir_type", "_ID"]].to_csv(EXPORT_FOLDER / 'screen_binders_single_motifs.csv', index=False)
...
screen_nonbinders[["7mer", "true label", "avg_z_score", "lir_type", "_ID"]].to_csv(EXPORT_FOLDER / 'screen_nonbinders_single_motifs.csv', index=False)
